...
import com.portafolio.dao.FacturaDao;
import com.portafolio.dao.VentaDao;
import com.portafolio.domain.Producto;
import com.portafolio.domain.Usuario;
import com.portafolio.domain.Factura;
import com.portafolio.domain.Item;
import com.portafolio.domain.Venta;
import com.portafolio.service.UsuarioService;
import com.portafolio.service.ItemService;
...
import com.portafolio.dao.ProductoDao;
...
public class ItemServiceImpl implements ItemService {
    ...
    public void delete(Item item) {
        ...
        var existe = false;
        for (Item i : listaItems) {
            ++posicion; //(le sumo 1 a la posicion)
            if (Objects.equals(i.getIdProducto(), item.getIdProducto())) {
                existe = true;
                break;
            }
